...
import { handleGetCategories } from '../screen/Home/HomeApi';
...
const PopSelectType: React.FC<Props> = ({ visible, closed, onChoose }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        >
          <ScrollView>
            {[{ id: -1, name: 'Tất cả' }, ...dataCategory].map((itemCategory: any) => {
              return (
                <Pressable onPress={() => onChoose({ type_id: itemCategory.id === -1 ? null : itemCategory })} style={styles.viewTouchable}>
